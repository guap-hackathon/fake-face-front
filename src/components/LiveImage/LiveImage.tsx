  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: '#fff' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <Button onClick={startCamera} style={{ marginRight: '10px' }}>Начать трансляцию</Button>
        <Button onClick={stopCamera} style={{ marginRight: '10px' }}>Остановить трансляцию</Button>
      </div>
    </div>
  );
};
